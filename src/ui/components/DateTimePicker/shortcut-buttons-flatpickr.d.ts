// using an untyped plugin for flatpickr
declare module "shortcut-buttons-flatpickr" {
    ...
    export default function ShortcutButtonsPlugin(config: ShortcutButtonsFlatpickr.Config): (
        fp: Flatpickr
    ) => {
        onReady: () => void;
        onDestroy: () => void;

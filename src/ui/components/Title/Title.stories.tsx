...
import { H0, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11 } from "@deskpro/deskpro-ui";
...
const customAsComponent = () => {
    return <a href="http://some.link" target="_blank">link to somewhere</a>
};

const typographyMap = { H0, H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11 };
